...
int main(int argc, char **argv)
{
        ...
        printf("Xmodem my personal interpretation..: copyright(c)2025\n");
        printf("Made by: who know, I find this in internet and copied from brave screen...\n");
        printf("Changed by pdsilva (AKA pgordao)\n");

        serial_fd = open_serial("/dev/ttyUSB0", 9600);
        if (serial_fd < 0)
                return -errno;
